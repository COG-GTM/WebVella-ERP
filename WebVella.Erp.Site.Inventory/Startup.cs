...
using WebVella.Erp.Plugins.Finance;
using WebVella.Erp.Plugins.Workflow;
using WebVella.Erp.Plugins.Inventory;
using WebVella.Erp.Plugins.SDK;
using WebVella.Erp.Web;
using WebVella.Erp.Web.Middleware;

namespace WebVella.Erp.Site.Inventory
{
	...
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			.AddCookie(CookieAuthenticationDefaults.AuthenticationScheme, options =>
            {
				...
				options.Cookie.Name = "erp_auth_inventory";
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			.UseErpPlugin<FinancePlugin>()
			.UseErpPlugin<WorkflowPlugin>()
			.UseErpPlugin<InventoryPlugin>()
			.UseErp()
			.UseErpMiddleware()
			.UseJwtMiddleware();
